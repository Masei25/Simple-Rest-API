...
class PersonGateway
{
    ...
    {
        $statement = "SELECT id, firstname, lastname, firstparent_id, secondparent_id 
    ...
    public function insert(Array $input)
    {
        ...
        try {
            $statement = $this->db->exec([
                'firstname' => $input['firstname'],
                'lastname' => $input['lastname'],
                'firstparent_id' => $input['firstparent_id'],
                'secondparent_id' => $input['secondparent_id']
            ]);
